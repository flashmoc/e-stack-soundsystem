...
| HIGH R | ampli HIGH / Fosi | même position | ≈19.9 dB* | 11.5 Vrms | ≈16.5 W @ 8 Ω | -5.1 dBFS | -6.1 dB |
...
- Le seuil `Compresseur` HIGH R est confirmé par l'utilisateur comme identique à HIGH L : **-6.1 dB**.
